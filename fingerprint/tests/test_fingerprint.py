...
class TestFingerprint:
    ...
    def test_fingerprints_match_same(self, tmp_path):
    ...
    def test_fingerprints_match_different_size(self, tmp_path):
        file1 = tmp_path / "file1.txt"
        file2 = tmp_path / "file2.txt"
        file1.write_text("hello")
    ...
    def test_fingerprints_match_different_mtime(self, tmp_path):
        import time
...
class TestFingerprintPerformance:
    ...
    def test_sha256_not_computed_when_mtime_differs(self, tmp_path):
        import time
